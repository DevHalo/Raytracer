...
void invert::invert_matrix(double A[4][4], double Ainv[4][4]) {
	int i, j;
	double det;
...
void invert::adjoint(double in[4][4], double out[4][4]) {
...
double invert::det4x4(double m[4][4])
{
	double ans;
...
double invert::det3x3(double a1, double a2, double a3, double b1, double b2, double b3, double c1,
	double c2, double c3)
{
	double ans;
...
//double det2x2( a, b, c, d)
  //   double a, b, c, d; 
double invert::det2x2(double a, double b, double c, double d)
{
	double ans;
	ans = a * d - b * c;
	return ans;
